    ...
    docDefination.content.push(
        ...
        },
        {
            ol: [
                ...
                'ผู้รับอนุญาตตั้งสถานบริการจะต้องไม่กระทำการฝ่าฝืนข้อห้ามตามพระราชบัญญัติสถานบริการ พ.ศ.2509 และจะต้องปฏิบัติตามเงื่อนไขแห่งพระราชบัญญัติดังกล่าวรวมทั้งกฎกระทรวงและประกาศกระทรวงที่ เกี่ยวข้องโดยเคร่งครัด',
                ...
                'ใบอนุญาตให้ตั้งสถานบริการให้ใช้ได้จนถึง 31 ธันวาคม ของปีที่ระบุในใบอนุญาต ผู้รับอนุญาตผู้ใด ประสงค์จะขอต่ออายุใบอนุญาต จะต้องยื่นคำขอเสียก่อนใบอนุญาตสิ้นอายุ'
            ],
            margin: [0,20,0,0]
        },
    )
